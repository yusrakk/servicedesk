...
.hero__badge {
  ...
  color:rgba(255,255,255,.74); background:rgba(255,255,255,.12);
  border:1px solid rgba(255,255,255,.18); padding: .3rem .9rem; border-radius: 99px; margin-bottom: 1rem;
}
...
.hero__title { font-size: clamp(1.5rem, 4vw, 2.25rem); font-weight: 800; color:#ffffff; letter-spacing: -.03em; line-height: 1.1; margin-bottom: .5rem; }
