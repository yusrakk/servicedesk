...
@media(max-width:640px){.page-header{flex-direction:column;gap:.875rem;padding:1.25rem 1.25rem 1.75rem;}.tabs{padding:.75rem 1.25rem 0;}.tab-content{padding:1rem;}.page-header__meta{width:100%;}}
</style>