          ...
          <div class="layout-container">
            <div class="info-card">
              ...
              <div class="info-row textarea-row">
                ...
                <strong class="link-surat">Pesan dari SuperAdmin</strong>
            ...
            <span v-if="dokumen" class="file-info">
              ...
              <div class="tinjau-card">
                <h3 class="judul-tinjau">Tinjau Pelayanan</h3>
                <div class='wrapper-setuju'>
                  <h4 class="judul-input-tambahan">Pilih Pelaksana Teknis</h4>
                  ...
                  <h4 class="judul-input-tambahan">Pesan untuk Pelaksana Teknis</h4>
                  <textarea class="textarea-row-tambahan" v-model="pesanUnit"></textarea>
                  <button class="btn-selesai-detail" @click="handleSelesai">Selesai</button>
                </div>
              </div>
              <button class="btn-reposisi" @click="openReposisi">Reposisi</button>
              <button class="btn-disposisi" @click="openDisposisi">Disposisi</button>
              <button class="btn-tolak" @click="openTolak">Tolak</button>
                <PopupModel
                    v-if="showReposisi"
                    type="reposisi"
                    title="Reposisi Pelayanan"
                    description="Masukkan tujuan reposisi:"
                    confirmText="Kirim"
                    @close="closePopups"
                    @submit="handleReposisi"
                  />
                <PopupModel
                    v-if="showDisposisi"
                    type="disposisi"
                    title="Disposisi Pelayanan"
                    description="Masukkan pesan disposisi:"
                    confirmText="Kirim"
                    @close="closePopups"
                    @submit="handleDisposisi"
                  />
                ...
                <PopupModel 
                    ...
                    description="Keterangan Penolakan:"
                    confirmText="Tolak"
                    @close="closePopups"
                    @submit="handleTolak"
                  />
...
.btn-tolak {
  ...
  cursor: pointer;
  margin-right: 8px; /* jarak antar button */
...
/* optional: button terakhir tanpa margin */
.btn-tolak {
  margin-right: 0;
}
