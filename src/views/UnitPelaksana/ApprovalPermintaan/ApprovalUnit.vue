...
onMounted(() => {
  ...
  axios.get('/api/unit/pelayanan', { headers: { Authorization: 'Bearer ' + token } })
    .then(res => {
...
function lihatDetail(item) {
  router.push({ name: 'DetailPelayananPelaksana', query: { layanan: item.noTiket } })
}
  ...
  <div class="approval-page">
    ...
    <div class="page-header">
      <div class="page-header__content">
        ...
        <h1 class="page-header__title">Persetujuan Pelayanan</h1>
        <p class="page-header__sub">Tinjau dan setujui permintaan pelayanan yang masuk</p>
      </div>
    ...
    <div class="body">
      <div class="toolbar">
        <div class="search-box">
          ...
          <input v-model="search" type="text" placeholder="Cari tiket, perihal, perangkat daerah..." class="search-input"/>
      ...
      <div class="table-card">
        ...
        <div v-else-if="filteredItems.length === 0" class="state-center">
          ...
          <p>{{ search ? 'Tidak ada hasil pencarian' : 'Belum ada permintaan pelayanan' }}</p>
        </div>
...
.th-sortable:hover{color:var(--color-emerald);}
.sort-icon{display:inline-flex;align-items:center;margin-left:.375rem;color:var(--color-silver);}
