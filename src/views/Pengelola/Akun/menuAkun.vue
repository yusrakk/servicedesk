...
@media(max-width:640px){.page-header{flex-direction:column;padding:1.5rem 1.25rem 2rem;}.body{padding:1rem;}.stats-row{grid-template-columns:1fr;}.form-grid{grid-template-columns:1fr;}}
</style>