...
.page-header{background:linear-gradient(135deg,var(--cf),var(--ce));padding:2rem 2rem 2.5rem;position:relative;overflow:hidden;display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;}
