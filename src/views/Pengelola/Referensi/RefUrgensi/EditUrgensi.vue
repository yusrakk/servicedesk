...
function handleSubmit() {
  ...
  axios.put(`/api/urgensi/${urgensiId.value}`, { Nama_Urgensi: namaUrgensi.value }, { headers: { Authorization: 'Bearer ' + token } })
    .then(() => router.push('/referensi/urgensi'))
    .catch(e => alert(e.response?.data?.message || 'Gagal mengubah urgensi.'))
  ...
  <div class="form-page">
    <div class="page-header">
      ...
      <div>
        ...
        <h1 class="page-header__title">Ubah Urgensi</h1>
        <p class="page-header__sub">Edit data urgensi: <strong style="color:white">{{ route.query.nama_urgensi }}</strong></p>
      </div>
      <div class="orb"></div>
    </div>
    <div class="body">
      <div class="form-card">
        ...
        <div class="form-body">
          <div class="field">
            ...
            <input v-model="namaUrgensi" type="text" class="field__input" placeholder="Nama urgensi..." @keyup.enter="handleSubmit"/>
          </div>
          <div class="form-actions">
            <button class="fbtn fbtn--ghost" type="button" @click="router.push('/referensi/urgensi')">Batal</button>
