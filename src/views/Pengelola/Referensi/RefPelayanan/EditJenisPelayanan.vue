...
function handleSubmit() {
  ...
  axios.put(`/api/jenispelayanan/update/${jenisPelayananId.value}`, { Nama_Jenis_Pelayanan: namaJenisPelayanan.value }, { headers: { Authorization: 'Bearer ' + token } })
    .then(() => router.push('/referensi/jenis-pelayanan'))
    .catch(e => alert(e.response?.data?.message || 'Gagal mengubah jenis pelayanan.'))
  ...
  <div class="form-page">
    <div class="page-header">
      ...
      <div>
        ...
        <h1 class="page-header__title">Ubah Jenis Pelayanan</h1>
        <p class="page-header__sub">Edit data: <strong style="color:white">{{ route.query.nama_jenis_pelayanan }}</strong></p>
      </div>
      <div class="orb"></div>
    </div>
    <div class="body">
      <div class="form-card">
        ...
        <div class="form-body">
          <div class="field">
            ...
            <input v-model="namaJenisPelayanan" type="text" class="field__input" placeholder="Nama jenis pelayanan..." @keyup.enter="handleSubmit"/>
          </div>
          <div class="form-actions">
            <button class="fbtn fbtn--ghost" type="button" @click="router.push('/referensi/jenis-pelayanan')">Batal</button>
