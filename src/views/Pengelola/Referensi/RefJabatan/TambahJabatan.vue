...
function handleSubmit() {
  ...
  axios.post('/api/jabatan', { Nama_Jabatan: namaJabatan.value }, { headers: { Authorization: 'Bearer ' + token } })
    .then(() => router.push('/referensi/jabatan'))
    .catch(e => alert(e.response?.data?.message || 'Gagal menambah jabatan.'))
  ...
  <div class="form-page">
    <div class="page-header">
      ...
      <div>
        ...
        <h1 class="page-header__title">Tambah Jabatan</h1>
        <p class="page-header__sub">Tambahkan jabatan baru ke dalam sistem</p>
      </div>
      <div class="orb"></div>
    </div>
    <div class="body">
      <div class="form-card">
        <div class="form-card__header">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="4" width="12" height="10" rx="1.5" stroke="currentColor" stroke-width="1.3"/><path d="M5 4V3a3 3 0 016 0v1" stroke="currentColor" stroke-width="1.3"/></svg>
        ...
        <div class="form-body">
          <div class="field">
            ...
            <input v-model="namaJabatan" type="text" class="field__input" placeholder="Contoh: Kepala Dinas, Staf Ahli..." @keyup.enter="handleSubmit"/>
          </div>
          <div class="form-actions">
            <button class="fbtn fbtn--ghost" type="button" @click="namaJabatan=''">Reset</button>
