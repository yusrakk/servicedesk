...
@media(max-width:640px){.page-header{flex-direction:column;padding:1.25rem;margin:0 0 1.5rem;border-radius:20px;}.body{padding:1rem;}.form-grid,.file-grid{grid-template-columns:1fr;}}
</style>