    ...
    axios
      ...
      .catch((error) => {
        ...
        if (error.response?.status === 401) passwordError.value = true;
          ...
          console.error('Login error tanpa response:', error);
          alert('Gagal terhubung ke server. Cek apakah tunnel ngrok & server Laravel kamu masih aktif.');
        }
      });
  } catch (error) {
    isLoading.value = false;
      ...
      <div class="login-left__inner">
        ...
        <div class="left-copy animate-fade-up delay-1">
          <h1 class="left-copy__title">
            Selamat Datang<br />
            di <em>Servicedesk</em><br />
            Diskominfo Jabar
          </h1>
          <p class="left-copy__desc">Platform terpadu untuk permintaan dan pengaduan layanan Infrastruk dan teknologi informasi di lingkungan Perangkat Daerah Provinsi Jawa Barat.</p>
        </div>
      </div>
    </div>
        ...
        <div class="login-form">
          ...
          <div class="field">
            ...
            <div class="field__input-wrap">
              ...
              <input v-model="NIP" type="text" class="field__input" :class="{ 'field__input--error': NIPerror || isEmpty }" placeholder="Masukkan NIP Anda" @keyup.enter="login" />
            </div>
          ...
          <div class="field">
            ...
            <div class="field__input-wrap">
              ...
              <input v-model="Password" :type="showPassword ? 'text' : 'password'" class="field__input" :class="{ 'field__input--error': passwordError || isEmpty }" placeholder="Masukkan password" @keyup.enter="login" />
          ...
          <transition name="err-slide">
            <div v-if="isEmpty" class="alert alert--warning">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M7 2l5.5 10H1.5L7 2z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round" />
                <path d="M7 6v2.5M7 10v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" />
              </svg>
