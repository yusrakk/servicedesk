    ...
    .then(res => {
      ...
      items.value = res.data
        .filter(i => {
          ...
          return (
            ['Selesai', 'Tutup', 'Ditolak'].includes(i.status_pelayanan?.Nama_Status) &&
...
function checkProgress(item) {
  router.push({ name: 'DetailKepuasanUserBulanIni', query: { layanan: item.ticket } })
}
  ...
  <div class="page">
    <div class="page-header">
      <div>
        ...
        <h1 class="page-header__title">Laporan Kepuasan Bulan Ini</h1>
        <p class="page-header__sub">Pelayanan berstatus Selesai, Tutup, atau Ditolak pada bulan berjalan</p>
      </div>
      <div class="orb"></div>
    </div>
    ...
    <div class="body">
      ...
      <div class="table-card">
        ...
        <div v-else-if="filteredItems.length === 0" class="state-center">
          ...
          <p>{{ search ? 'Tidak ada hasil pencarian' : 'Tidak ada data bulan ini' }}</p>
        </div>
