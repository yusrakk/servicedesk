...
.page-header {
  ...
  padding: 1.5rem 2rem 2rem;margin:0 0 1.5rem; display: flex; align-items: flex-start; gap: 1rem;
...
@media (max-width: 640px) {
  .page-header { flex-direction: column; gap: .875rem; padding: 1.25rem 1.25rem 1.75rem;margin:0 0 1.5rem;border-radius:20px;}
