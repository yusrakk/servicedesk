...
onMounted(() => {
  ...
  axios.get('/api/pelayanan/disposisi/teknis', { headers: { Authorization: 'Bearer ' + token } })
    .then(res => {
...
function lihatDetail(item) {
  router.push({ name: 'DetailDisposisiTeknis', query: { layanan: item.noTiket } })
}
  ...
  <div class="page">
    <div class="page-header">
      <div>
        ...
        <p class="page-header__sub">Daftar pelayanan yang didisposisikan ke teknis</p>
      </div>
    ...
    <div class="body">
      <div class="toolbar">
        ...
        <span class="result-count">{{ filteredItems.length }} pelayanan</span>
      </div>
      ...
      <div class="table-card">
        ...
        <div v-else-if="filteredItems.length === 0" class="state-center">
          ...
          <p>{{ search ? 'Tidak ada hasil pencarian' : 'Tidak ada data disposisi' }}</p>
        </div>
